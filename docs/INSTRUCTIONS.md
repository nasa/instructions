...
## Table of Contents
- [Purpose](#purpose)
- [Instructions for Who Can Become a Member](#instructions-for-who-can-become-a-member)
...
## Instructions for Who Can Become a Member
Only NASA staff can become a member of the NASA org on github.com and release code in [github.com/nasa](https://github.com/nasa) org.

If you are a NASA civil servant or contractor and would like to be added to the Public NASA GitHub Org, you will need to submit the AGCY NASA GitHub Collaborator Form [NAMS request ](https://nams.nasa.gov) https://nams.nasa.gov. This requires you to be behind the NASA firewall. If you were a member several years ago and recently found you are no longer a member, please read this [note](https://github.com/nasa/nasa.github.io/issues/2).

Only members have rights to directly edit code in a [github.com/nasa](https://github.com/nasa) repository. Everyone else will need to submit a pull request. We highly encourage pull requests from the public!!! However, please note that not all repositories are actively maintained. If you look at NASA code repositories on the [github.com/nasa](https://github.com/nasa) front-page, there is a little sparkline (small inline chart) showing activity over time. Projects with lots of activities are more likely to quickly accept a pull request. Members of the public can not attain and do not need collaborator status. ***You don't need any special status to submit pull requests or add issues.***

For information on how to become a member of the NASA Org (you need to be a NASA civil servant or contractor with access to systems inside the NASA firewall), please read the instructions on [code.nasa.gov/#/guide](https://code.nasa.gov/#/guide).

### Instructions for Once You Are a Member
***Please read these instructions in full as using github.com/nasa has some differences with how you might be familar with using github.com on personal projects.***
...
**Only org owners have the ability to create new repositories, bring new users in as members of the NASA github org, and make changes to settings of repositories**. If there is something a member of the nasa org can not do that this arragement prevents, please reach out.
...
If you are in need for a new repository (and it has gotten SRA approval) please either submit a modification to your NAMs request with the following information:
...
- Make or modify a request to start a new repository in github.com/nasa via the [NAMs request](href="https://idmax.nasa.gov/nams/asset/227756). Please give it a useful name and good documentation! We'll create a blank repository for you to put the code into. Please note that you will not be able to get to that link if you are not inside the NASA firewall. In your NAMs request, please include all the required metadata describing the respository listed in the "REPO" section above. If this is the first repository you're open sourcing, you might also want to read through the longer description of how to supply the metadata [here](https://github.com/nasa/instructions/blob/master/docs/about_section_instructions.md).
<hr>
...
- Modify your [NAMs request](https://idmax.nasa.gov/nams/asset/227756) to request the team creation or email the two owners above. Give team name and which repositories team members should be given access to. Please note that you will not be able to get to that link if you are not inside the NASA firewall.
<hr>
...
- Send an email to an NASA org admin using the standard contact email listed on this page. Supply a link to the issue or pull request with the spam and the username of who needs to be blocked. 
...
[Internal information](https://wiki.jsc.nasa.gov/fod/index.php/Knowledge_Any_Developer_New_to_NASA_Will_Need_to_Know) on internal code platforms
...
For example, [this webpage creates visualizations of trends and connections between NASA repositories](https://justingosses.github.io/nasa-repos-visual-explorer/explore/) across many org accounts and not just github.com/nasa.
...
## Questions
If you have any question, you may leave an issue on this repository or contact us via <a href="mailto:nasa-data@lists.arc.nasa.gov">nasa-data@lists.arc.nasa.gov</a>. We will use those questions & answers to eventually make a FAQ section on this page.
